...
```json
{
  "teambit.generator/generator": {
    "envs": [
      "nore-work.train/envs/react-component-env"
    ]
  }
}
```
...
```
bit env set my-component nore-work.train/envs/react-component-env
```
...
```
bit new react my-workspace --aspect nore-work.train/envs/react-component-env
```
